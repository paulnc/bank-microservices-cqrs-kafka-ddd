...
package com.tecbank.account.query.api.controllers;

import com.tecbank.account.query.api.dto.AccountLookupResponse;
import com.tecbank.account.query.api.dto.EqualityType;
import com.tecbank.account.query.api.queries.FindAccountByHolderQuery;
import com.tecbank.account.query.api.queries.FindAccountByIdQuery;
import com.tecbank.account.query.api.queries.FindAccountWithBalanceQuery;
import com.tecbank.account.query.api.queries.FindAllAccountsQuery;
...
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAccountByHolder(@PathVariable(value = "account") String accountHolder) {
        try {
